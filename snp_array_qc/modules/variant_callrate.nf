...
process VARIANT_CALLRATE {
    ...
    publishDir "${params.outdir}/04_variant_qc/tables",       mode: params.publish_dir_mode, pattern: "*.{lmiss,txt}"
    publishDir "${params.outdir}/04_variant_qc/plots",        mode: params.publish_dir_mode, pattern: "*.png"
    publishDir "${params.outdir}/04_variant_qc/cleaned_data", mode: params.publish_dir_mode, pattern: "*.{bed,bim,fam}", enabled: params.keep_intermediate
